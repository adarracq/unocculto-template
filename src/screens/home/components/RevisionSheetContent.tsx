        ...
        <View style={styles.container}>
            ...
            <View style={styles.statsContainer}>
                <View style={styles.statRow}>
                    ...
                    <View style={styles.textBlock}>
                        <CyberText variant="h3" style={{ color: THEME.colors.text.primary }}>MÉMOIRE CRITIQUE</CyberText>
                ...
                <View style={styles.statRow}>
                    <View style={styles.iconBoxPrimary}>
                        <RefreshCw size={20} color={THEME.colors.inProgress} />
                    </View>
                    <View style={styles.textBlock}>
                        <CyberText variant="h3" style={{ color: THEME.colors.text.primary }}>EN CONSOLIDATION</CyberText>
                        <CyberText variant="bodySmall" colorType="disabled">Apprentissage en cours.</CyberText>
                    </View>
                    <CyberText variant="h2" style={{ color: THEME.colors.inProgress }}>{consolidationCount}</CyberText>
                </View>
                ...
                <View style={styles.statRow}>
                    ...
                    <View style={styles.textBlock}>
                        <CyberText variant="h3" style={{ color: THEME.colors.text.primary }}>MAÎTRISE TOTALE</CyberText>
            ...
            <View style={styles.actionContainer}>
                <MyButton
                    ...
                    iconRight={urgentCount > 0 ? 'chevron-forward' : "checkmark-done"}
                    iconLeft='school'
...
const styles = StyleSheet.create({
    ...
    statsContainer: { backgroundColor: THEME.colors.glass.background, borderRadius: 16, borderWidth: 1, borderColor: THEME.colors.glass.border, padding: 16, marginBottom: 24 },
    ...
    iconBoxPrimary: { width: 40, height: 40, borderRadius: 12, backgroundColor: THEME.colors.inProgress + '15', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: THEME.colors.inProgress + '40' },
